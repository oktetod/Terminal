...
def load_lora_models_from_json(json_dir="/root"):
    """
...
image = (
    ...
    .copy_local_file("01.json", "/root/01.json")
    .copy_local_file("03.json", "/root/03.json")
    .copy_local_file("04.json", "/root/04.json")
    .copy_local_file("05.json", "/root/05.json")
    .copy_local_file("07.json", "/root/07.json")
)
...
def download_loras():
    ...
    lora_models = load_lora_models_from_json("/root")
...
class ModelInference:
    ...
    def load_model(self):
        ...
        self.lora_models = load_lora_models_from_json("/root")
