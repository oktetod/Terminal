...
def load_lora_models_from_json():
    """
...
@app.function(image=image, volumes={LORA_DIR: lora_volume}, timeout=7200)
def download_loras():
    """
...
class ModelInference:
    ...
    def load_model(self):
        ...
        self.lora_models = load_lora_models_from_json()
...
def fastapi_app():
    ...
    lora_models = load_lora_models_from_json()
