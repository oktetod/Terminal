...
def download_loras():
    ...
    logger.info(f"⭐ Already existed (skipped): {len(skipped_existing)}")
...
class ModelInference:
    ...
    def load_model(self):
        ...
        try:
            ...
            logger.info(f"✅ {len(self.lora_models)} LoRAs available")
    ...
    def _apply_lora(self, pipe, lora_name: Optional[str], lora_scale: float):
        ...
        if lora_name and lora_name in self.lora_models:
            try:
                ...
                logger.info(f"✅ LoRA {lora_name} applied")
...
def main():
    ...
    print("\n" + "="*70)
    print("🚀 CIVITAI API - PRODUCTION DEPLOYMENT (FIXED)")
    print("="*70)
    print("\n🐛 BUG FIXES:")
    print("  ✅ Pydantic import error resolved")
    print("  ✅ Explicit library versions specified")
    print("  ✅ Import order corrected")
    ...
    print("="*70)
    print("\n🎯 What Changed:")
    print("  • Added explicit pydantic==2.9.2 in pip install")
    print("  • Added pydantic-settings==2.5.2")
    print("  • Fixed import order (utilities before Pydantic models)")
    print("  • Added try-except for pydantic import")
    print("  • Pinned all library versions for stability")
    print("  • Updated version to 4.0.1")
    print("="*70 + "\n")